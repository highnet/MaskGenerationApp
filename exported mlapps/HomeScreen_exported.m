classdef HomeScreen_exported < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.Image10.Position = [325 292 152 119];
            app.Image10.ImageSource = 'Start.PNG';

            % Create Image11
            app.Image11 = uiimage(app.UIFigure);
            app.Image11.Position = [160 451 463 150];
            ...
            app.StartLabel.Position = [366 254 73 39];
            ...
            app.HelpLabel.Position = [517 -3 55 30];
            ...
            app.GetImagesLabel.Position = [338 115 130 30];
            ...
            app.ExamplesLabel.Position = [160 1 111 30];
            ...
            app.ImageEditorLabel.Position = [129 115 142 30];
            ...
            app.UserManualLabel.Position = [321 1 142 30];
            app.UserManualLabel.Text = 'User Manual';

            % Create SettingsLabel
            app.SettingsLabel = uilabel(app.UIFigure);
            app.SettingsLabel.FontName = 'Arial';
            app.SettingsLabel.FontSize = 24;
            app.SettingsLabel.FontColor = [1 1 1];
            app.SettingsLabel.Position = [507 114 92 30];
